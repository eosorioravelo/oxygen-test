...
<!ENTITY % ishlabelxpath-general-default
           "ishlabelxpath       CDATA #FIXED    './title | @alt | @href | @conref | self::*[@id and not(@varid)]/@id'">


<!-- ============================================================= IMPORTANT: Don't make the length of these xpaths longer than 250 characters as this causes serious issues with XMetaL ============================================================= -->

<!ENTITY % ishlinkxpath-general-default
           "ishlinkxpath        CDATA #FIXED    '@conref | @href[contains(parent::*/@class,&apos; topic/image &apos;) and not(parent::*/@conref)][not(ancestor::*[@scope and @scope!=&apos;&apos;][position()=1]/@scope=&apos;external&apos;)]'">

<!ENTITY % ishlinkxpath-longdescref-default
           "ishlinkxpath        CDATA #FIXED    '@conref | @href[contains(parent::*/@class,&apos; topic/longdescref &apos;) and not(parent::*/@conref)][not(ancestor::*[@scope and @scope!=&apos;&apos;][position()=1]/@scope=&apos;external&apos;)]'">

<!ENTITY % ishlinkxpath-longquoteref-default
          "ishlinkxpath        CDATA #FIXED     '@conref | @href[contains(parent::*/@class,&apos; topic/longquoteref &apos;) and not(parent::*/@conref)][not(ancestor::*[@scope and @scope!=&apos;&apos;][position()=1]/@scope=&apos;external&apos;)]'">

<!ENTITY % ishhyperlinkxpath-general-default
           "ishhyperlinkxpath   CDATA #FIXED    '@href[not(ancestor::*[@scope and @scope!=&apos;&apos;][position()=1]/@scope=&apos;external&apos;)]'">

<!ENTITY % ishlinkxpath-section-default
           "ishlinkxpath        CDATA #FIXED    '@href[not(ancestor::*[@scope and @scope!=&apos;&apos;][position()=1]/@scope=&apos;external&apos;)]'">

<!ENTITY % ishlabelxpath-section-default
           "ishlabelxpath       CDATA #FIXED    './topicmeta/navtitle[not(parent::*/parent::*/@href)] | @navtitle[not(parent::*/@href)] | @href[ancestor::*[@scope and @scope!=&apos;&apos;][position()=1]/@scope=&apos;external&apos;]'">

<!ENTITY % ishlinkxpath-object-default
           "ishlinkxpath        CDATA #FIXED    '@conref | @data[not(contains(.,&apos;:&apos;))] | *[(@name=&apos;movie&apos; or @name=&apos;URL&apos; or @name=&apos;src&apos;) and contains(@class,&apos; topic/param &apos;) and not(@conref)][not(contains(@value,&apos;:&apos;))]/@value'">

<!ENTITY % ishlabelxpath-object-default
           "ishlabelxpath       CDATA #FIXED    '@name | @conref | self::*[@id and not(@varid)]/@id'">

<!ENTITY % ish-root-element-atts
           "ishlabelxpath       CDATA #FIXED    './title'">

<!ENTITY % ish-illustration-atts
...
<!ENTITY % ish-object-atts
           "%ishlabelxpath-object-default;
            %ishlinkxpath-object-default;
            ishtype             CDATA #FIXED    'ISHIllustration'
            ishpreviewversion   CDATA #IMPLIED">
...
<!ENTITY % longquoteref.attributes
             "href 
              ...
              %univ-atts;
              %ishlabelxpath-general-default;
              %ishlinkxpath-longquoteref-default;
              outputclass 
                        CDATA 
                                  #IMPLIED
              ishtype
...
<!ENTITY % longdescref.attributes
             "href 
              ...
              %univ-atts;
              %ishlabelxpath-general-default;
              %ishlinkxpath-longdescref-default;
              outputclass 
                        CDATA 
                                  #IMPLIED
              ishtype
